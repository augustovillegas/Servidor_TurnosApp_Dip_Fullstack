...
import { aprobarUsuarioController, listarUsuariosController, loginController, pingController, registerController } from "../controllers/authController.mjs";
...
router.patch("/aprobar/:id", auth, allowRoles("superadmin","profesor"), aprobarUsuarioController);
